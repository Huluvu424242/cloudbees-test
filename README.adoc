...
image:https://maven-badges.herokuapp.com/maven-central/com.github.piugroup/cloudbees-test/badge.svg?style=flat["Maven Central", link="https://maven-badges.herokuapp.com/maven-central/com.github.PIUGroup/cloudbees-test"]
// image:https://api.bintray.com/packages/piugroup/funthomas424242-libs/cloudbees-test/images/download.svg[link="https://bintray.com/PIUGroup/funthomas424242-libs/cloudbees-test/_latestVersion"]
image:https://travis-ci.org/PIUGroup/cloudbees-test.svg?branch=master["Build Status", link="https://travis-ci.org/PIUGroup/cloudbees-test"]
image:https://api.codacy.com/project/badge/Grade/88bf76546176437ea389629a2087d1b5["Codacy code quality", link="https://www.codacy.com/app/PIUGroup/cloudbees-test?utm_source=github.com&utm_medium=referral&utm_content=PIUGroup/cloudbees-test&utm_campaign=Badge_Grade"]
image:https://codecov.io/gh/PIUGroup/cloudbees-test/branch/master/graph/badge.svg[link="https://codecov.io/gh/PIUGroup/cloudbees-test"]
image:http://images.webestools.com/buttons.php?frm=2&btn_type=11&txt=Scrum Board["Scrum Board,scaledwidth="15%"", link="https://github.com/PIUGroup/cloudbees-test/projects/1"]
...
[#hintergrund]
== Hintergrund
Lange habe ich versucht ein Projekttemplate zu erstellen. Es gibt dazu bereits einige Projekte (beispielsweise https://github.com/PIUGroup/rades.scaffolding[rades.scaffolding])in meinem persönlichem Account. Doch nun ist mir Github dankenswerter Weise zuvor gekommen und hat einen Mechanismus angeboten ein bestehendes Projekt als Template Projekt zu markieren. Das konnte ich prima nutzen und möchte mich dafür recht herzlich Bedanken.
...
https://github.com/PIUGroup[@Huluvu424242]
...
Du kannst aber auch jederzeit gern ein Ticket öffnen unter: https://github.com/PIUGroup/cloudbees-test/issues/new/choose[Ticket Erstellen].

Dieses Projekt folgt den unter https://piugroup.github.io/cloudbees-test/code-of-conduct.txt[Verhaltenskodex] abgelegten Verhaltensregeln. Welche auch unter https://www.contributor-covenant.org/de/version/1/4/code-of-conduct/[Verhaltenskodex für Unterstützer] veröffentlicht wurden.
